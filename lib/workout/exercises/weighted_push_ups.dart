...
class WeightedPushUpsLogic extends BaseExercise {
  bool _isDown = false;

  WeightedPushUpsLogic(super.targetReps) {
    feedback = "Weight on back, hands shoulder-width";
  }
  ...
  void processPose(Pose pose) {
    ...
    if (backOk) {
      // Even stricter for weighted — back MUST be board straight
      final backAngle = angle(lShoulder!, lHip!, lAnkle!);
      if (backAngle < 160) {
        feedback = "Back must be perfectly straight with weight!";
        return;
      }
    }
    ...
    if (!_isDown && elbowAngle > 160) feedback = "Lower chest controlled ↓";
