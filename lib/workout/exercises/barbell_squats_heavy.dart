...
class BarbellSquatsHeavyLogic extends BaseExercise {
  bool _isDown = false;

  BarbellSquatsHeavyLogic(super.targetReps) {
    feedback = "Bar on traps, chest up, feet wide";
  }
  ...
  void processPose(Pose pose) {
    ...
    if (torsoOk) {
      ...
      if (torsoAngle < 120) {
        feedback = "Chest up! Don't lean too far forward";
        return;
      }
    }
    ...
    if (!_isDown && kneeAngle > 165) feedback = "Squat to parallel ↓";

    if (kneeAngle < 90) {
      if (!_isDown) { _isDown = true; feedback = "Drive through heels ↑"; }
    }
